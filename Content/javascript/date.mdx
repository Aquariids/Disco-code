...
<div className='mini_tag_js'>[getMonth,]()</div>
<div className='mini_tag_js'>[getDate,]()</div>
<div className='mini_tag_js'>[getDay,]()</div>
<div className='mini_tag_js'>[getHours,]()</div>
<div className='mini_tag_js'>[getMinutes,]()</div>
<div className='mini_tag_js'>[getSeconds,]()</div>
<div className='mini_tag_js'>[getMilliseconds,]()</div>
<div className='mini_tag_js'>[getTimezoneOffset,]()</div>
<div className='mini_tag_js'>[getTime,]()</div>
<div className='mini_tag_js'>[getTimezoneOffset,]()</div>
<div className='mini_tag_js'>[getTimezoneOffset,]()</div><br/>
