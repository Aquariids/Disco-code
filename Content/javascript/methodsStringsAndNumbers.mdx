...
<div className = 'mini_tag_js'>[Почему мы можем использовать метод на строке, если это примитив?](/js/basicjs/OOPAndPrototype#как-работают-примитивы-в-js)</div><br/> 
<div className = 'mini_tag_js'><a target={"_blank"}  href="https://developer.mozilla.org/ru/docs/Web/JavaScript/Reference/Global_Objects/String">Методы строк на MDN </a></div><br/> 
<div className = 'mini_tag_js'><a target={"_blank"}  href="https://developer.mozilla.org/ru/docs/Web/JavaScript/Reference/Global_Objects/Number">Методы чисел на MDN  </a></div>
