...
getElementsByTagName() - получаем <a href="https://discocode.ru/js/basicjs/arrays#%D0%BF%D1%81%D0%B5%D0%B2%D0%B4%D0%BE%D0%BC%D0%B0%D1%81%D1%81%D0%B8%D0%B2%D1%8B" className = 'link_js'>псевдомассив</a> по тегу (Даже если будет один элемент, мы все равно получим псевдомассив)
```javaScript   
