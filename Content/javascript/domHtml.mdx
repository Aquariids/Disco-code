...
console.log(bg);
```
<div className='container-img'> <span className="img"> ![getElementById](/images/Content/Js/getElementById.png) </span></div>

### getElementsByTagName() ###
getElementsByTagName() - получаем <a href="http://localhost:3000/js/basicjs/arrays#%D0%BF%D1%81%D0%B5%D0%B2%D0%B4%D0%BE%D0%BC%D0%B0%D1%81%D1%81%D0%B8%D0%B2%D1%8B" className = 'link_js'>псевдомассив</a> по тегу (Даже если будет один элемент, мы все равно получим псевдомассив)
```javaScript   
const btns = document.getElementsByTagName('button');
console.log(btns); 
```
<div className='container-img'> <span className="img"> ![getElementById](/images/Content/Js/getElementsByTagName.png) </span></div>
...
<div className='container-img'> <span className="img"> ![getElementById](/images/Content/Js/getElementsByTagName[i].png) </span></div>
...
```
<div className='container-img'> <span className="img"> ![getElementById](/images/Content/Js/getElementsByClassName.png) </span></div>
...
```
<div className='container-img'> <span className="img"> ![getElementById](/images/Content/Js/querySelectorAll.png) </span></div>
...
<div className='container-img'> <span className="img"> ![getElementById](/images/Content/Js/querySelector.png) </span></div>
...
<div className='container-img'> <span className="img"> ![consoledir](/images/Content/Js/consoledir.png) </span></div>
...
<div className='container-img'> <span className="img"> ![Style](/images/Content/Js/Style.png) </span></div>
...
```
<div className='container-img'> <span className="img"> ![Style](/images/Content/Js/cssStyle.png) </span></div>
...
```
<div className='container-img'> <span className="img"> ![Style](/images/Content/Js/forEach.png) </span></div>
...
```
<div className='container-img'> <span className="img"> ![Style](/images/Content/Js/append.png) </span></div>
...
<div className='container-img'> <span className="img"> ![Style](/images/Content/Js/prepend.png) </span></div>
...
```
<div className='container-img'> <span className="img"> ![Style](/images/Content/Js/beforAfter.png) </span></div>
...
<div className='container-img'> <span className="img"> ![Style](/images/Content/Js/removeandreplace.png) </span></div>
...
section.append(div);
```
<div className='container-img'> <span className="img"> ![Style](/images/Content/Js/innerHTML.png) </span></div>
...
<div className='container-img'> <span className="img"> ![Style](/images/Content/Js/insertAdjacentHTML.png) </span></div>
