...
id: 11
prev: '/js/basic-js/objects'
next: '/js/basic-js/arrays'
category: 'basic-js'
---
...
<div className = 'mini_tag_js'>[Почему мы можем использовать метод на строке, если это примитив?](/js/basicjs/OOPAndPrototype)</div><br/> 
