...
По факту класс это красивая обертка <span className = 'link_js'>[функции конструктора](/js/basic-js/constructor-function) </span> - синтаксический сахар.<br/>
