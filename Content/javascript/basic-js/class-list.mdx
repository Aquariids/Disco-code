...
<span className = 'link_js'> [Ранее](/content/js/basic-js/dom#работаем-с-css-селекторами-classlist) </span> мы использовали один метод `add` у `classList` для добавления класса, сейчас же мы будем работать в полную силу.
...
<div className='container-img'> <span className="img"> ![alt text](/images/Content/Js/basic-js/class-list/add.png) </span></div>
