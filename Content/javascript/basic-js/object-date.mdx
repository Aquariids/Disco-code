...
title: 'Объект Date'
id: 25
prev: '/js/basic-js/animation-set-interval'
next: '/js/basic-js/objects-document-and-window'
category: 'basic-js'
---
...
<div className='container-img'> <span className="img"> ![alt text](/images/Content/Js/basic-js/object-date/UTC.png) </span></div>
