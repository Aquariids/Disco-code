...
getElementsByTagName() - получаем <span className = 'link_js'> [псевдомассив](/js/basic-js/arrays#псевдомассивы) </span> по тегу (Даже если будет один элемент, мы все равно получим псевдомассив)
```javaScript   
