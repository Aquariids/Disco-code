...
id: 0
next: '/js/basic-js/use-strict'
category: 'basic-js'
---
<div className = 'mdHead'>
#### Теги
<div className = 'tag_js'> [Консоль разработчика](#консоль-разработчика)</div>  <br/>
<div className = 'tag_js'> [Методы для общения с пользователем:](#методы-для-общения-с-пользователем) </div>
<div className = 'mini_tag_js'> [alert](#alert) </div> 
<div className = 'mini_tag_js'> [prompt](#prompt) </div>
<div className = 'mini_tag_js'> [confirm](#confirm) </div>
...
<div className='container-img'> <span className="img"> ![console.log](/images/Content/Js/basic-js/browser-methods-and-console/console.png) </span></div>
...
```
<div className='container-img'> <span className="img"> ![console.log](/images/Content/Js/basic-js/browser-methods-and-console/hello.png) </span>  </div>
...
alert('Hello world')
```
<div className='container-img'> <span className="img"> ![alert](/images/Content/Js/basic-js/browser-methods-and-console/alert.png) </span></div>
...
```
<div className='container-img'> <span className="img"> ![prompt](/images/Content/Js/basic-js/browser-methods-and-console/prompt.png) </span></div>
...
```
<div className='container-img'> <span className="img"> ![confirm](/images/Content/Js/basic-js/browser-methods-and-console/confirm.png) </span> </div>
