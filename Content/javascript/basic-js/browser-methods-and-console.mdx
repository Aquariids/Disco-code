...
<div className='container-img'> <span className="img"> ![console.log](/images/Content/Js/console.png) </span></div>
...
```
<div className='container-img'> <span className="img"> ![console.log](/images/Content/Js/hello.png) </span>  </div>
...
alert('Hello world')
```
<div className='container-img'> <span className="img"> ![alert](/images/Content/Js/alert.png) </span></div>
...
```
<div className='container-img'> <span className="img"> ![prompt](/images/Content/Js/prompt.png) </span></div>
...
```
<div className='container-img'> <span className="img"> ![confirm](/images/Content/Js/confirm.png) </span> </div>
