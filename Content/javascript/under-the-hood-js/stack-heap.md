...
* Heap - мы уже знакомы с кучей, и в первом уроке этого руководства говорили, о том, что в куче <b>хранятся все объекты и функции</b> и то, что это динамическая часть памяти. 
...
* Stack - это структура данных, которая представляет собой упорядоченный набор элементов, работающий по принципу "последним пришел - первым ушел.
