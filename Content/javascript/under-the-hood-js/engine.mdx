...
<b> Если вы вдруг зашли сюда и читаете это, то знайте в описании jit компиляции я немного ошибся, перед машинным кодом, ast преобразуется в байт код и выполняется на вирутальной машине, пока происходят  оптимизации и байт код понемногу заменяется оптимизированным машинным кодом. Я опишу все это нормально и удалю это сообщение после 06.03.2023 </b>
