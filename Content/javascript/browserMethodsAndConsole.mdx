...
<div className='container-img'> <span className="img"> ![alt text](/images/Content/Js/console.png) </span></div>
...
```
<div className='container-img'> <span className="img"> ![alt text](/images/Content/Js/hello.png) </span>  </div>
...
alert('Hello world')
```
<div className='container-img'> <span className="img"> ![alt text](/images/Content/Js/alert.png) </span></div>
...
```
<div className='container-img'> <span className="img"> ![alt text](/images/Content/Js/prompt.png) </span></div>
...
```
<div className='container-img'> <span className="img"> ![alt text](/images/Content/Js/confirm.png) </span> </div>
