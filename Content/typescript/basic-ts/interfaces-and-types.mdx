...
id: '2'
prev: '/ts/basicts/types'
next: '/ts/basicts/literal-types'
category: 'basicts'
---
...
<div className='container-img'> <span className="img"> ![ts](/images/Content/ts/noneAs.png) </span></div>
...
<div className='container-img'> <span className="img"> ![ts](/images/Content/ts/as.png) </span></div>
