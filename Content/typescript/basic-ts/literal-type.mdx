...
<div className='container-img'> <span className="img"> ![alt text](/images/Content/ts/literalType1.png) </span></div>
...
<div className='container-img'> <span className="img"> ![alt text](/images/Content/ts/literalType2.png) </span></div>
...
<div className='container-img'> <span className="img"> ![alt text](/images/Content/ts/literalType3.png) </span></div>
