...
title: 'Типы данных'
id: '1'
prev: '/ts/installation'
next: '/ts/interfacesAndTypes'
category: 'basicts'
---
...
<div className = 'tag_ts'>[Базовые типы в typeScript:]()</div>  
<div className = 'mini_tag_ts'> [number,]()</div> 
<div className = 'mini_tag_ts'> [string,]()</div> 
<div className = 'mini_tag_ts'> [boolean.]()</div> <br/>
<div className = 'tag_ts'>[Если не указывать тип данных:]()</div>  
<div className = 'mini_tag_ts'> [any,]()</div>
<div className = 'mini_tag_ts'> [null и undefined.]()</div> <br/>
<div className = 'tag_ts'>[Массивы:]()</div>  
<div className = 'mini_tag_ts'> [string,]()</div>
<div className = 'mini_tag_ts'> [number.]()</div> <br/>
<div className = 'tag_ts'>[Типизация функций:]()</div>  
<div className = 'mini_tag_ts'> [аргументы.]()</div> 
<div className = 'mini_tag_ts'> [тип возвращаемого функцией,]()</div>
<div className = 'mini_tag_ts'> [void,]()</div> <br/>
<div className = 'tag_ts'>[Знак | (union тип)]()</div>  <br/>
<div className = 'tag_ts'>[Объекты]()</div>  <br/>
<div className = 'tag_ts'>[Знак ?]()</div>  <br/>
<div className = 'tag_ts'>[Проверка на тип:]()</div>  
<div className = 'mini_tag_ts'> [isArray]()</div>
