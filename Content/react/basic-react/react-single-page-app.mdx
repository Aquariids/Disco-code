...
<div className = 'tag_react'>[Начало работы с React](#начало-работы-с-react)</div> <br/>
...
function App() {
  ...
  return(
    ...
    <div style={{background:'gray', maxWidth: '180px'}} className='App'>
        <div style={{color:'#fff'}}> Привет прекрасный мир </div>
    </div>
  )
}
