...
И увидим, что лайв сервер готов и что typescript тоже готов к работе.
 ...
 <div className='container-img'> <span className="img"> ![console.log](/images/Content/next-js/npm_run_dev.png) </span></div>

Так же не забудем переименовать файлы в папке `page` из `js` формата в `tsx`.

 <div className='container-img'> <span className="img"> ![console.log](/images/Content/next-js/tsx.png) </span></div>
