...
import { POSTS_PATH_ADVANCED_JS, POSTS_PATH_ALGORITHMS_JS, POSTS_PATH_BASIC_JS, POSTS_PATH_PRACTICE_JS, POSTS_PATH_UNDER_THE_HOOD_JS, POSTS_PATH_INTERVIEW_JS} from "../../../api/paths";
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  const { content, meta } = getPostFromSlug(js, POSTS_PATH_INTERVIEW_JS);
...
export const getStaticPaths: GetStaticPaths = async () => {
  const paths = getSlugs(POSTS_PATH_INTERVIEW_JS).map((js) => ({ params: { js } }));
