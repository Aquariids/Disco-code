...
import { POSTS_PATH_ADVANCED_JS, POSTS_PATH_BASIC_JS, POSTS_PATH_ALGORITHMS_JS, POSTS_PATH_PRACTICE_JS, POSTS_PATH_UNDER_THE_HOOD_JS, POSTS_PATH_INTERVIEW_JS } from '../../../api/paths';
    ...
    return (
        <div className='page'>
            <Head>
                ...
                <meta property='og:description' content={'Разбор алгоритмов на javascript'} />
            ...
            <div className='mdTitle'>
                ...
                <div className={cn(s.edit, 'page_edit')}><a target='_blank' rel='noopener' href={`https://github.com/Aquariids/Disco-code/blob/main/Content/javascript/algorithms-js/${post.meta.slug}.mdx`}> Отредактировать эту страницу</a><img style={{ width: '30px', height:"30px", paddingLeft: '5px' }} src='/edit.svg' /></div>
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
    ...
    const { content, meta } = getPostFromSlug(js, POSTS_PATH_ALGORITHMS_JS);
...
export const getStaticPaths: GetStaticPaths = async () => {
    const paths = getSlugs(POSTS_PATH_ALGORITHMS_JS).map(js => ({ params: { js } }));
