      ...
      <div className={s.container}>
        ...
        <div>
          ...
          <div className={s.containerNewPages}>
            ...
            <span className={s.newPage}>Добавлена новая статья от том как работают <Link href={'web-request-response'}>web запросы и ответы</Link><span className={s.dateNewPage}>30.11.2022</span></span>
