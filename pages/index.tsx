    ...
    <div className={s.body}>
      ...
      <div className={s.container}>
        ...
        <div>
          ...
          <div className={s.containerNewPages}>
            <span className={s.newPage}>Добавлен новый раздел "Практика js" и добавил статью про <Link href={'js/practice-js/webpack'}>Webpack</Link><span className={s.dateNewPage}>17.11.2022</span></span>
            ...
            <span className={s.newPage}>Добавлена новая статья о том как работают <Link href={'web-request-response'}>web запросы и ответы</Link><span className={s.dateNewPage}>30.11.2022</span></span>
