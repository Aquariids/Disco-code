      ...
      <div className={s.container}>
        ...
        <div>
          ...
          <ul className={s.containerNewPages}>
            ...
            <span className={s.newPage}>Добавленна новая статья от том как работают <Link href={'web-request-response'}>web запросы и ответы</Link><span className={s.dateNewPage}>30.11.2022</span></span>
