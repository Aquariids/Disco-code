...
function MyApp(_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(head_1["default"], null,
            ...
            React.createElement("link", { rel: "icon", href: "/favicon.ico", type: "image/x-icon" }),
        ...
        React.createElement(react_yandex_metrika_2.YMInitializer, { accounts: [], options: { webvisor: false, defer: true }, version: "2" }),
