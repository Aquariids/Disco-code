  ...
  return (
    <div className={s.main}>
      <Head>
        ...
        <meta name="description" content={"JavaScript тесты разных уровней"} />
        <meta
      ...
      <AnimationContainer>
        <QuizCard
          category="beginner"
          src="/tests/beginner/"
          text="Для разработчиков JavaScript, которые только начинают изучать язык или недавно начали"
          title={"Тесты для начинающих"}
        />
      </AnimationContainer>
    </div>
  );
