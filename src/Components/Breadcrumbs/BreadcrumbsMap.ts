import { ADVANCED_JS, ALGORITHMS_JS, BASIC_JS, BASIC_NEXT_JS, BASIC_NODE_JS, BASIC_REACT, BASIC_TS, HTML, HTML_CSS, JS, NEXT_JS, NODE_JS, PARADIGMS, PARADIGMS_STYLE, PRACTICE_JS, REACT, TS, UNDER_THE_HOOD_JS, WEB } from "../../../pages/api/pages";
