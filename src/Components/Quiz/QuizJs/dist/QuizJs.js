...
var QuizJs = function (_a) {
    ...
    var _d = react_1.useState(0), currentQuestion = _d[0], setCurrentQuestion = _d[1];
    var _e = react_1.useState(false), showEndScore = _e[0], setShowEndScore = _e[1];
    var _f = react_1.useState(1), score = _f[0], setScore = _f[1];
    var _g = react_1.useState(0), rigthAnswers = _g[0], setRigthAnswers = _g[1];
    var _h = react_1.useState(true), disabledBtn = _h[0], setDisabledBtn = _h[1];
    ...
    var nekoText = document.querySelector("." + QuizJs_module_scss_1["default"].neko__oval);
    ...
    return (react_1["default"].createElement(AnimationContainer_1["default"], null, showEndScore ? (react_1["default"].createElement("div", { className: QuizJs_module_scss_1["default"].quiz },
        react_1["default"].createElement("div", { className: QuizJs_module_scss_1["default"].end_container },
            ...
            react_1["default"].createElement("div", { className: QuizJs_module_scss_1["default"].quiz__end },
                react_1["default"].createElement("div", { className: classnames_1["default"](QuizJs_module_scss_1["default"].quiz__score_end, (_b = {},
                    ...
                    react_1["default"].createElement("span", { style: { color: "black" } },
                        ...
                        " - "),
                    " ", percent + "%"),
                react_1["default"].createElement("div", { className: QuizJs_module_scss_1["default"].neko },
                    react_1["default"].createElement("blockquote", { className: QuizJs_module_scss_1["default"].neko__oval })),
                react_1["default"].createElement("div", { className: classnames_1["default"]((_c = {},
                        _c[QuizJs_module_scss_1["default"].nice] = percent === 100,
                        _c[QuizJs_module_scss_1["default"].middle] = percent > 55 && percent != 100,
                        _c[QuizJs_module_scss_1["default"].bad] = percent < 55 && percent != 0 && percent > 30 || percent == 50,
                        _c[QuizJs_module_scss_1["default"].bad_bad] = percent < 30 && percent != 0,
                        _c[QuizJs_module_scss_1["default"].veryBad] = percent === 0,
                        _c)) }, percentForAnswer()))))) :
        react_1["default"].createElement("div", { onKeyDown: function (e) { return onKeyPressed(e); }, className: QuizJs_module_scss_1["default"].quiz },
            react_1["default"].createElement("div", { className: QuizJs_module_scss_1["default"].quiz__back },
                react_1["default"].createElement("span", null,
                    react_1["default"].createElement(link_1["default"], { href: '/tests/beginner' }, "\u0412\u0435\u0440\u043D\u0443\u0442\u044C\u0441\u044F \u043A \u0442\u0435\u0441\u0442\u0430\u043C"))),
